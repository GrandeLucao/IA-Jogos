...
public class OthelloGame extends AbstractGame {
	...
	public int testing_end_game(int[][] board, int markBoard) {
		...
		if (getValidMoves(board, 1).isEmpty() && getValidMoves(board, -1).isEmpty()) {
...
//            check col +
			if (boardPlace.getCol() + 1 < size && board[boardPlace.getRow()][boardPlace.getCol() + 1] != 0
					&& board[boardPlace.getRow()][boardPlace.getCol() + 1] != abstractPlayer.getBoardMark()) {// check
																												// right
...
//                check col -
			if (boardPlace.getCol() > 0 && board[boardPlace.getRow()][boardPlace.getCol() - 1] != 0
					&& board[boardPlace.getRow()][boardPlace.getCol() - 1] != abstractPlayer.getBoardMark()) {// check
																												// left
...
//                check row -
			if (boardPlace.getRow() > 0 && board[boardPlace.getRow() - 1][boardPlace.getCol()] != 0
					&& board[boardPlace.getRow() - 1][boardPlace.getCol()] != abstractPlayer.getBoardMark()) {// check
																												// up
...
//                check row +
			if (boardPlace.getRow() < size - 1 && board[boardPlace.getRow() + 1][boardPlace.getCol()] != 0
					&& board[boardPlace.getRow() + 1][boardPlace.getCol()] != abstractPlayer.getBoardMark()) {// check
																												// down
...
//                check main diagonal +
			if (boardPlace.getCol() < size - 1 && boardPlace.getRow() < size - 1
					&& board[boardPlace.getRow() + 1][boardPlace.getCol() + 1] != 0
					&& board[boardPlace.getRow() + 1][boardPlace.getCol() + 1] != abstractPlayer.getBoardMark()) {// check
																													// down
																													// right
...
//                check main diagonal -
			if (boardPlace.getCol() > 0 && boardPlace.getRow() > 0
					&& board[boardPlace.getRow() - 1][boardPlace.getCol() - 1] != 0
					&& board[boardPlace.getRow() - 1][boardPlace.getCol() - 1] != abstractPlayer.getBoardMark()) {// check
																													// up
																													// left
...
//                check second diagonal +
			if (boardPlace.getCol() > 0 && boardPlace.getRow() < size - 1
					&& board[boardPlace.getRow() + 1][boardPlace.getCol() - 1] != 0
					&& board[boardPlace.getRow() + 1][boardPlace.getCol() - 1] != abstractPlayer.getBoardMark()) {// check
																													// down
																													// left
...
//                check second diagonal -
			if (boardPlace.getCol() < size - 1 && boardPlace.getRow() > 0
					&& board[boardPlace.getRow() - 1][boardPlace.getCol() + 1] != 0
					&& board[boardPlace.getRow() - 1][boardPlace.getCol() + 1] != abstractPlayer.getBoardMark()) {// second
																													// up
																													// right
...
//        skip play
		...
		if (row >= 0 && col >= 0 && !empty) { // rdr - check if it is empty
			while (row != boardPlace.getRow() && col != boardPlace.getCol()) {
				if (board[row][col] != 0) {
